...
Dataset state: **29 entries**, `meta.lastUpdated` 2026-08-01. Generated 2026-08-01.
...
| Governance emphasized | 11 | 38% |
| Enabler, not bottleneck | 9 | 31% |
| Language as infrastructure | 7 | 24% |
| Central standards function | 7 | 24% |
| GEO & SEO | 5 | 17% |
| Structured data | 5 | 17% |
| Model behavior design | 5 | 17% |
| Content marketing adjacent | 4 | 14% |
| Accessibility as structural constraint | 4 | 14% |
| Content-adjacent | 3 | 10% |
| Classification for ML | 3 | 10% |
...
Recorded in `jd-source` front matter. **21 of 29** postings say where the role sits; the rest do not, which is itself a fact about the posting.
