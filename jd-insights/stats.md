...
Dataset state: **30 entries**, `meta.lastUpdated` 2026-08-07. Generated 2026-08-07.
...
- **30** entries across **25** companies and **8** domains
- Date range: 2026-05-24 to 2026-08-07

## Responsibility clusters

| | Entries | Share |
|---|---:|---:|
| Content systems design | 27 | 90% |
| Enablement & team upskilling | 24 | 80% |
| AI tooling & automation | 19 | 63% |
| AI-generated content governance | 16 | 53% |
| Taxonomy & information architecture | 15 | 50% |
| Terminology & language governance | 13 | 43% |
| Technical writing & documentation | 10 | 33% |
| Localization & internationalization | 6 | 20% |

## Skill signals

| | Entries | Share |
|---|---:|---:|
| AI fluency expected | 18 | 60% |
| Governance emphasized | 13 | 43% |
| Enabler, not bottleneck | 11 | 37% |
| Language as infrastructure | 9 | 30% |
| Central standards function | 9 | 30% |
| Model behavior design | 6 | 20% |
| Content marketing adjacent | 5 | 17% |
| GEO & SEO | 5 | 17% |
| Structured data | 5 | 17% |
| Accessibility as structural constraint | 4 | 13% |
| Content-adjacent | 3 | 10% |
| Title ≠ stated responsibilities | 2 | 7% |
| Classification for ML | 2 | 7% |
| Structured for agent retrieval | 2 | 7% |
| Title dilution | 1 | 3% |

## Compensation

- Stated in **23 of 30** entries (22 USD, 1 CAD)
- Full spread: **$65,000** to **$710,000**
- USD medians: **$125,500** low, **$186,100** high
- `covers`: 18 base, 3 unstated, 2 total

## Compensation by signal

USD entries only (22 of 23 stated ranges). Signals carried by at least 3 of them.

| Signal | n | Median low | Median high | vs. all USD |
|---|---:|---:|---:|---:|
| **All USD entries** | 22 | $125,500 | $186,100 | — |
| Language as infrastructure | 6 | $149,650 | $251,000 | +$64,900 |
| Accessibility as structural constraint | 4 | $168,100 | $237,400 | +$51,300 |
| Model behavior design | 4 | $148,500 | $229,500 | +$43,400 |
| AI fluency expected | 12 | $137,500 | $199,500 | +$13,400 |
| Enabler, not bottleneck | 7 | $133,000 | $190,000 | +$3,900 |
| Central standards function | 8 | $132,000 | $190,000 | +$3,900 |
| Governance emphasized | 12 | $126,500 | $186,100 | — |
| Structured data | 5 | $115,000 | $157,800 | −$28,300 |
| GEO & SEO | 5 | $90,000 | $157,800 | −$28,300 |
| Content marketing adjacent | 4 | $100,000 | $155,000 | −$31,100 |
...
Words appearing in 3 or more of the 30 stored titles. Counted from `title`, which is stored verbatim — so this reflects what employers wrote, not what the site renders.
...
| | Entries | Companies |
|---|---:|---|
| Big Tech | 8 | Apple, Google, LinkedIn, Meta, OpenAI |
| Finance | 6 | Ally Financial, Chime, Insurify, JPMorgan Chase, Sanna, Wealthsimple |
| SaaS | 5 | Adobe, CoLab, Figma, Notion, Zoom |
| Media | 4 | Netflix, Spotify |
| E-commerce | 3 | HelloFresh, The Ride Platform, Wellhub |
...
Recorded in `jd-source` front matter. **23 of 30** postings say where the role sits; the rest do not, which is itself a fact about the posting.
...
**5 of 30** postings state a date. Where both exist, the gap to `dateAdded` varies enough that one is not a proxy for the other.
