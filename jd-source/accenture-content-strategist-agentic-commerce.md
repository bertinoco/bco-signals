---
id: accenture-content-strategist-agentic-commerce
company: Accenture
...
partial: true
captureNote: >
  TRANSCRIBED, NOT PASTED. Every other file in this directory is copied text;
  this one was typed out from eight mobile screenshots. Transcription can
  ...
  06/24/2026" — which is not a posting date and is therefore not recorded in
  postedDate.

  The title carries a pipe separator, which renders as a comma under the
...
5+ years of experience in content strategy, structured content systems, or enterprise information architecture, including industry experience in Retail and Consumer Goods & Services.
...
We anticipate this job posting will be posted until 06/24/2026.
...
[GAP — the screenshots do not cover the text between the Washington salary row above and the "Requesting an Accommodation" heading below. Any further location rows in the salary table are not captured.]
...
[GAP — the final screenshot ends mid-sentence here. The remainder of the posting is not captured.]
