---
id: wellhub-senior-global-ux-writer
company: Wellhub
title: Senior Global UX Writer, Content Systems
sourceUrl: null
sourcePlatform: company-site
orgPlacement: "Consumer Digital Experience team"
dateAdded: 2026-05-24
captured: 2026-07-27
captureMethod: pasted-from-claude-chat
captureNote: >
  Captured from Wellhub's own careers listing. Every bullet in the "YOUR
  IMPACT" and "Who You Are" sections is terminated with a semicolon rather
  than a period, which affects how a quote lifted from one verifies against
  this text. The posting states no compensation, matching the entry's null
  compRange.
---
...
We are hiring a Senior Global UX Writer to our Consumer Digital Experience team in the United States (Eastern Time Zone)!
...
You have 5+ years of experience in UX writing, content design, content strategy, information architecture, taxonomy design, localization, or related system-level content work — ideally within global or multi-market products;
You have proven experience building or maintaining classification systems, controlled vocabularies, glossaries, canonical term databases, or structured content models;
You understand localization deeply, including translation workflows, string management, variable structures, and internationalization constraints;
You proactively identify systemic inefficiencies and design processes that prevent recurring content issues;
You are comfortable navigating ambiguity, balancing multiple high-priority initiatives, and making informed trade-offs to deliver scalable solutions;
You collaborate effectively across Product, Engineering, Design, Marketing, and Localization, clearly and persuasively articulating complex structural decisions;
You are skilled in producing content within design tools such as Figma. Experience with content management systems (e.g., Ditto, Frontitude, Supernova, headless CMS environments) is strongly preferred;
You have experience with localization/translation management systems (e.g., Phrase, Lokalise, etc.);
You are open to leveraging AI writing tools responsibly to support scalable content systems and workflow efficiency;
You thrive in a remote-first environment with asynchronous communication and strong ownership;
You are in the Eastern Standard Time zone and can work remotely;
Native English speaker required (Portuguese is a plus).
